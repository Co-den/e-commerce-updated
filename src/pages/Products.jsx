...
const Product = () => {
  ...
  return (
    <div className="container mx-auto p-4 bg-white min-h-screen">
      <h2 className="text-3xl font-bold text-blue mb-6">Products</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((product, index) => (
          <motion.div
            ...
            className="bg-white border border-green p-4 rounded-lg shadow-lg hover:text- hover:bg-blue  transition-all"
          >
            <img
              src={product.image}
              alt={product.name}
            ...
            />
            <h3 className="text-blue text-sm font-semibold">{product.name}</h3>
